...
class AgentCar:
    ...
    def get_out_of_legal_lanes_reward(self, action):
        ...
        # cond1 = lane==4 and action=='left_lane_change'
        # cond2 = lane==6 and action=='right_lane_change'
        # if cond1 or cond2:
        #     print("\n\nOut of lane>>>>>>>>>>>>>>>>>>>\n\n")
        #     done = True
        #     reward_out = REWARD_OUT_OF_LEGAL_LANES
    ...
    def update(self, dt, car_list, car_list2, velocities, surface=None, train=False):
        done = False
        learn = False
